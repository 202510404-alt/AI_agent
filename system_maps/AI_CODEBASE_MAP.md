...
│   │   ├── indexer.py [📂 tools/python_agent_tools/indexer.py] -> [💡 📦 imp: ast, hashlib, json, os, pathlib.Path, typing.Any | 🧬 class AdvancedIndexerV2 [L25-310] |    └─ def __init__(project_root) [L34-42] |    └─ def _get_sha256(content) [L44-45] |    └─ def _extract_skeleton(content) [L47-63] |    └─ def parse_protocols_and_registries(content, rel_path_str) [L65-98] |    └─ def index_file(file_path) [L100-229] |    └─ def scan_project() [L231-310]]
